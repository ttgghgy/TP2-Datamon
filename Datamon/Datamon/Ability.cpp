...
unsigned short int Ability::GetPower() 
{
	return m_power;
}

unsigned char Ability::GetAccuracy()
{
	return m_accuracy;
}

unsigned char Ability::GetCritChance() 
{
	return m_critChance;
}
...
Ability* Ability::s_virusAbilities[4] =     {		   new Ability("Virus Ability 1", 50, 100, 0),
												  	   new Ability("Virus Ability 2", 50, 100, 0),
												 	   new Ability("Virus Ability 3", 50, 100, 0),
													   new Ability("Virus Ability 4", 50, 100, 0)};

Ability* Ability::s_biosAbilities[4] = {		       new Ability("BIOS Ability 1", 50, 100, 0),
													   new Ability("BIOS Ability 2", 50, 100, 0),
													   new Ability("BIOS Ability 3", 50, 100, 0),
													   new Ability("BIOS Ability 4", 50, 100, 0) };

Ability* Ability::s_overclockAbilities[4] =	  {		   new Ability("Overclock Ability 1", 50, 100, 100),
...
Ability* Ability::s_powershellAbilities[4] = {		   new Ability("PowerShell Ability 1", 50, 100, 0),
